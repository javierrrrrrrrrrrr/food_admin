...
import 'package:food_admin/features/categories/presentation/pages/add_categorie_page.dart';
              ...
              children: [
                ...
                SlidableAction(
                  onPressed: ((context) async {
                    //producto
                    if (isproduct == true) {
                      productProvider.productoCategoryNameSelected = null;
                      loadingSpinner(
                          productProvider.scaffoldKey.currentContext!);
                      ...
                      //copia de la categoria
                      categoryProvider.copyCategoryselected = Category(
                        id: category!.id,
                        name: category!.name,
                        ...
                        category!.image == 'no-image.png'
                            ...
                            : FadeInImage(
                                ...
                                placeholder:
                                    const AssetImage('assets/loading.gif'),
                                image: NetworkImage(
                                  '${apiUrl}uploads/categories/${category!.id}',
                                ))
                    //
                    ),
                SizedBox(
